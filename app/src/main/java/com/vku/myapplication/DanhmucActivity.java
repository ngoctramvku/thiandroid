...
public class DanhmucActivity extends AppCompatActivity {
    ...
    public static ArrayList<Cart> mainCartArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_dog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DanhmucActivity.this, MainActivity.class);
                i.putExtra("ctg_id", 1);
                startActivity(i);
            }
        });
        ...
        btndn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DanhmucActivity.this, LoginActivity.class);
                startActivity(i);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DanhmucActivity.this, Register_Activity.class);
                startActivity(i);
            }
        });
